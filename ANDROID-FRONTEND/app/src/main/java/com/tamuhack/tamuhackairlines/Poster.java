...
public class Poster {
    ...
    private static String surround(Object str) {
        return "\"" + str + "\"";
    }
    ...
    private static String getJSONStringMult(Map<String, Object> jsonMap) {
        String result = "{";
        for (Iterator<String> it = jsonMap.keySet().iterator(); it.hasNext();) {
            String key = it.next();
            result += surround(key) + ": " + surround(jsonMap.get(key));
    ...
    public static String POSTMULT(String server, Map<String, Object> jsonMap) {
        URL url;
        ...
        String result = getJSONStringMult(jsonMap);
